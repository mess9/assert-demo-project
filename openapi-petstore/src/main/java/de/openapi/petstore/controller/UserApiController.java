...
public class UserApiController implements UserApi {
  ...
  public ResponseEntity<User> _createUser(
  ...
  public ResponseEntity<Void> _deleteUser(
  ...
  public ResponseEntity<User> _getUserByName(
  ...
  public ResponseEntity<String> _loginUser(
  ...
  public ResponseEntity<Void> _updateUser(
